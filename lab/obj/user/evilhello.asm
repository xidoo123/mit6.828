...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800b7a:	68 1b 23 80 00       	push   $0x80231b
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  800f20:	68 27 23 80 00       	push   $0x802327
  800f25:	68 ef 22 80 00       	push   $0x8022ef
  800f2a:	6a 62                	push   $0x62
  800f2c:	68 3c 23 80 00       	push   $0x80233c
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  800f6d:	68 48 23 80 00       	push   $0x802348
  800f72:	68 ef 22 80 00       	push   $0x8022ef
  800f77:	6a 6d                	push   $0x6d
  800f79:	68 3c 23 80 00       	push   $0x80233c
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800ff3:	68 54 23 80 00       	push   $0x802354
  800ff8:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  8010a3:	50                   	push   %eax
  8010a4:	56                   	push   %esi
  8010a5:	68 5b 23 80 00       	push   $0x80235b
