...
sys_env_destroy(envid_t envid)
{
  ...
  80010f:	68 ca 22 80 00       	push   $0x8022ca
  800114:	6a 23                	push   $0x23
  800116:	68 e7 22 80 00       	push   $0x8022e7
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800190:	68 ca 22 80 00       	push   $0x8022ca
  800195:	6a 23                	push   $0x23
  800197:	68 e7 22 80 00       	push   $0x8022e7
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001d2:	68 ca 22 80 00       	push   $0x8022ca
  8001d7:	6a 23                	push   $0x23
  8001d9:	68 e7 22 80 00       	push   $0x8022e7
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800214:	68 ca 22 80 00       	push   $0x8022ca
  800219:	6a 23                	push   $0x23
  80021b:	68 e7 22 80 00       	push   $0x8022e7
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800256:	68 ca 22 80 00       	push   $0x8022ca
  80025b:	6a 23                	push   $0x23
  80025d:	68 e7 22 80 00       	push   $0x8022e7
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800298:	68 ca 22 80 00       	push   $0x8022ca
  80029d:	6a 23                	push   $0x23
  80029f:	68 e7 22 80 00       	push   $0x8022e7
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8002da:	68 ca 22 80 00       	push   $0x8022ca
  8002df:	6a 23                	push   $0x23
  8002e1:	68 e7 22 80 00       	push   $0x8022e7
...
sys_ipc_recv(void *dstva)
{
  ...
  80033e:	68 ca 22 80 00       	push   $0x8022ca
  800343:	6a 23                	push   $0x23
  800345:	68 e7 22 80 00       	push   $0x8022e7
...
sys_e1000_try_send(void *data, uint32_t len)
{
  ...
  80039f:	68 ca 22 80 00       	push   $0x8022ca
  8003a4:	6a 23                	push   $0x23
  8003a6:	68 e7 22 80 00       	push   $0x8022e7
...
sys_e1000_try_recv(void *buf, uint32_t* len)
{
  ...
  8003e1:	68 ca 22 80 00       	push   $0x8022ca
  8003e6:	6a 23                	push   $0x23
  8003e8:	68 e7 22 80 00       	push   $0x8022e7
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  8004cf:	ba 74 23 80 00       	mov    $0x802374,%edx
	int i;
	for (i = 0; devtab[i]; i++)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  8004fa:	51                   	push   %ecx
  8004fb:	50                   	push   %eax
  8004fc:	68 f8 22 80 00       	push   $0x8022f8
...
read(int fdnum, void *buf, size_t n)
{
  ...
  800724:	53                   	push   %ebx
  800725:	50                   	push   %eax
  800726:	68 39 23 80 00       	push   $0x802339
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  8007f9:	53                   	push   %ebx
  8007fa:	50                   	push   %eax
  8007fb:	68 55 23 80 00       	push   $0x802355
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8008ae:	53                   	push   %ebx
  8008af:	50                   	push   %eax
  8008b0:	68 18 23 80 00       	push   $0x802318
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  800b04:	68 88 23 80 00       	push   $0x802388
  800b09:	68 8f 23 80 00       	push   $0x80238f
  800b0e:	6a 7c                	push   $0x7c
  800b10:	68 a4 23 80 00       	push   $0x8023a4
  800b15:	e8 24 0a 00 00       	call   80153e <_panic>
	assert(r <= PGSIZE);
  800b1a:	3d 00 10 00 00       	cmp    $0x1000,%eax
  800b1f:	7e 16                	jle    800b37 <devfile_read+0x65>
  800b21:	68 af 23 80 00       	push   $0x8023af
  800b26:	68 8f 23 80 00       	push   $0x80238f
  800b2b:	6a 7d                	push   $0x7d
  800b2d:	68 a4 23 80 00       	push   $0x8023a4
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800bfe:	68 bb 23 80 00       	push   $0x8023bb
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  800fa4:	68 c7 23 80 00       	push   $0x8023c7
  800fa9:	68 8f 23 80 00       	push   $0x80238f
  800fae:	6a 62                	push   $0x62
  800fb0:	68 dc 23 80 00       	push   $0x8023dc
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  800ff1:	68 e8 23 80 00       	push   $0x8023e8
  800ff6:	68 8f 23 80 00       	push   $0x80238f
  800ffb:	6a 6d                	push   $0x6d
  800ffd:	68 dc 23 80 00       	push   $0x8023dc
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801077:	68 f4 23 80 00       	push   $0x8023f4
  80107c:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801127:	50                   	push   %eax
  801128:	56                   	push   %esi
  801129:	68 fb 23 80 00       	push   $0x8023fb
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8013cb:	68 13 24 80 00       	push   $0x802413
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80155a:	56                   	push   %esi
  80155b:	50                   	push   %eax
  80155c:	68 20 24 80 00       	push   $0x802420
  ...
  80156d:	e8 54 00 00 00       	call   8015c6 <vcprintf>
	cprintf("\n");
  801572:	c7 04 24 0c 24 80 00 	movl   $0x80240c,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8016c5:	0f be 80 43 24 80 00 	movsbl 0x802443(%eax),%eax
  8016cc:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  801890:	50                   	push   %eax
  801891:	68 5b 24 80 00       	push   $0x80245b
  801896:	53                   	push   %ebx
  801897:	56                   	push   %esi
  ...
  8018a8:	52                   	push   %edx
  8018a9:	68 a1 23 80 00       	push   $0x8023a1
  8018ae:	53                   	push   %ebx
  8018af:	56                   	push   %esi
  ...
  8018cd:	b8 54 24 80 00       	mov    $0x802454,%eax
