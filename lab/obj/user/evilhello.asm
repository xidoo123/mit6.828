...
sys_e1000_try_send(void *data, uint32_t len)
{
  ...
  80039f:	68 6a 22 80 00       	push   $0x80226a
  8003a4:	6a 23                	push   $0x23
  8003a6:	68 87 22 80 00       	push   $0x802287
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  80048d:	ba 14 23 80 00       	mov    $0x802314,%edx
	int i;
	for (i = 0; devtab[i]; i++)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  8004b8:	51                   	push   %ecx
  8004b9:	50                   	push   %eax
  8004ba:	68 98 22 80 00       	push   $0x802298
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  8007b7:	53                   	push   %ebx
  8007b8:	50                   	push   %eax
  8007b9:	68 f5 22 80 00       	push   $0x8022f5
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  80086c:	53                   	push   %ebx
  80086d:	50                   	push   %eax
  80086e:	68 b8 22 80 00       	push   $0x8022b8
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  800ac2:	68 28 23 80 00       	push   $0x802328
  800ac7:	68 2f 23 80 00       	push   $0x80232f
  800acc:	6a 7c                	push   $0x7c
  800ace:	68 44 23 80 00       	push   $0x802344
  800ad3:	e8 24 0a 00 00       	call   8014fc <_panic>
	assert(r <= PGSIZE);
  800ad8:	3d 00 10 00 00       	cmp    $0x1000,%eax
  800add:	7e 16                	jle    800af5 <devfile_read+0x65>
  800adf:	68 4f 23 80 00       	push   $0x80234f
  800ae4:	68 2f 23 80 00       	push   $0x80232f
  800ae9:	6a 7d                	push   $0x7d
  800aeb:	68 44 23 80 00       	push   $0x802344
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800bbc:	68 5b 23 80 00       	push   $0x80235b
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  800f62:	68 67 23 80 00       	push   $0x802367
  800f67:	68 2f 23 80 00       	push   $0x80232f
  800f6c:	6a 62                	push   $0x62
  800f6e:	68 7c 23 80 00       	push   $0x80237c
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  800fb4:	68 2f 23 80 00       	push   $0x80232f
  800fb9:	6a 6d                	push   $0x6d
  800fbb:	68 7c 23 80 00       	push   $0x80237c
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801035:	68 94 23 80 00       	push   $0x802394
  80103a:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  8010e5:	50                   	push   %eax
  8010e6:	56                   	push   %esi
  8010e7:	68 9b 23 80 00       	push   $0x80239b
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801389:	68 b3 23 80 00       	push   $0x8023b3
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801518:	56                   	push   %esi
  801519:	50                   	push   %eax
  80151a:	68 c0 23 80 00       	push   $0x8023c0
  ...
  80152b:	e8 54 00 00 00       	call   801584 <vcprintf>
	cprintf("\n");
  801530:	c7 04 24 ac 23 80 00 	movl   $0x8023ac,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  801683:	0f be 80 e3 23 80 00 	movsbl 0x8023e3(%eax),%eax
  80168a:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80184e:	50                   	push   %eax
  80184f:	68 fb 23 80 00       	push   $0x8023fb
  801854:	53                   	push   %ebx
  801855:	56                   	push   %esi
  ...
  801866:	52                   	push   %edx
  801867:	68 41 23 80 00       	push   $0x802341
  80186c:	53                   	push   %ebx
  80186d:	56                   	push   %esi
  ...
  80188b:	b8 f4 23 80 00       	mov    $0x8023f4,%eax
