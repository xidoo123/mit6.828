	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001ef:	0f be 80 d1 1d 80 00 	movsbl 0x801dd1(%eax),%eax
  8001f6:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8002eb:	ff 24 85 20 1f 80 00 	jmp    *0x801f20(,%eax,4)
  ...
  8003af:	8b 14 85 80 20 80 00 	mov    0x802080(,%eax,4),%edx
  8003b6:	85 d2                	test   %edx,%edx
  8003b8:	75 18                	jne    8003d2 <vprintfmt+0x15a>
				printfmt(putch, putdat, "error %d", err);
  8003ba:	50                   	push   %eax
  8003bb:	68 e9 1d 80 00       	push   $0x801de9
  8003c0:	53                   	push   %ebx
  8003c1:	56                   	push   %esi
  ...
  8003d2:	52                   	push   %edx
  8003d3:	68 b1 21 80 00       	push   $0x8021b1
  8003d8:	53                   	push   %ebx
  8003d9:	56                   	push   %esi
  ...
  8003f7:	b8 e2 1d 80 00       	mov    $0x801de2,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800a72:	68 df 20 80 00       	push   $0x8020df
  800a77:	6a 23                	push   $0x23
  800a79:	68 fc 20 80 00       	push   $0x8020fc
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800af3:	68 df 20 80 00       	push   $0x8020df
  800af8:	6a 23                	push   $0x23
  800afa:	68 fc 20 80 00       	push   $0x8020fc
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800b35:	68 df 20 80 00       	push   $0x8020df
  800b3a:	6a 23                	push   $0x23
  800b3c:	68 fc 20 80 00       	push   $0x8020fc
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800b77:	68 df 20 80 00       	push   $0x8020df
  800b7c:	6a 23                	push   $0x23
  800b7e:	68 fc 20 80 00       	push   $0x8020fc
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800bb9:	68 df 20 80 00       	push   $0x8020df
  800bbe:	6a 23                	push   $0x23
  800bc0:	68 fc 20 80 00       	push   $0x8020fc
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800bfb:	68 df 20 80 00       	push   $0x8020df
  800c00:	6a 23                	push   $0x23
  800c02:	68 fc 20 80 00       	push   $0x8020fc
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800c3d:	68 df 20 80 00       	push   $0x8020df
  800c42:	6a 23                	push   $0x23
  800c44:	68 fc 20 80 00       	push   $0x8020fc
...
sys_ipc_recv(void *dstva)
{
  ...
  800ca1:	68 df 20 80 00       	push   $0x8020df
  800ca6:	6a 23                	push   $0x23
  800ca8:	68 fc 20 80 00       	push   $0x8020fc
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800d8f:	ba 88 21 80 00       	mov    $0x802188,%edx
	int i;
	for (i = 0; devtab[i]; i++)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800dba:	51                   	push   %ecx
  800dbb:	50                   	push   %eax
  800dbc:	68 0c 21 80 00       	push   $0x80210c
...
read(int fdnum, void *buf, size_t n)
{
  ...
  800fe4:	53                   	push   %ebx
  800fe5:	50                   	push   %eax
  800fe6:	68 4d 21 80 00       	push   $0x80214d
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  8010b9:	53                   	push   %ebx
  8010ba:	50                   	push   %eax
  8010bb:	68 69 21 80 00       	push   $0x802169
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  80116e:	53                   	push   %ebx
  80116f:	50                   	push   %eax
  801170:	68 2c 21 80 00       	push   $0x80212c
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  8013c4:	68 98 21 80 00       	push   $0x802198
  8013c9:	68 9f 21 80 00       	push   $0x80219f
  8013ce:	6a 7c                	push   $0x7c
  8013d0:	68 b4 21 80 00       	push   $0x8021b4
  8013d5:	e8 bd 05 00 00       	call   801997 <_panic>
	assert(r <= PGSIZE);
  8013da:	3d 00 10 00 00       	cmp    $0x1000,%eax
  8013df:	7e 16                	jle    8013f7 <devfile_read+0x65>
  8013e1:	68 bf 21 80 00       	push   $0x8021bf
  8013e6:	68 9f 21 80 00       	push   $0x80219f
  8013eb:	6a 7d                	push   $0x7d
  8013ed:	68 b4 21 80 00       	push   $0x8021b4
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8014d0:	68 cb 21 80 00       	push   $0x8021cb
  8014d5:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801580:	50                   	push   %eax
  801581:	56                   	push   %esi
  801582:	68 d2 21 80 00       	push   $0x8021d2
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801824:	68 ea 21 80 00       	push   $0x8021ea
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8019b3:	56                   	push   %esi
  8019b4:	50                   	push   %eax
  8019b5:	68 f8 21 80 00       	push   $0x8021f8
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801a7e:	50                   	push   %eax
  801a7f:	68 1c 22 80 00       	push   $0x80221c
  801a84:	6a 49                	push   $0x49
  801a86:	68 29 22 80 00       	push   $0x802229
