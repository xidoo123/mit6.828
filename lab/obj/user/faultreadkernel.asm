	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001ef:	0f be 80 b1 1d 80 00 	movsbl 0x801db1(%eax),%eax
  8001f6:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003ba:	50                   	push   %eax
  8003bb:	68 c9 1d 80 00       	push   $0x801dc9
  8003c0:	53                   	push   %ebx
  8003c1:	56                   	push   %esi
  ...
  8003d2:	52                   	push   %edx
  8003d3:	68 ba 21 80 00       	push   $0x8021ba
  8003d8:	53                   	push   %ebx
  8003d9:	56                   	push   %esi
  ...
  8003f7:	b8 c2 1d 80 00       	mov    $0x801dc2,%eax
...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  80135c:	83 ec 0c             	sub    $0xc,%esp
	...
	panic("devfile_write not implemented");
  80135f:	68 78 21 80 00       	push   $0x802178
  801364:	68 90 00 00 00       	push   $0x90
  801369:	68 96 21 80 00       	push   $0x802196
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  8013a5:	68 a1 21 80 00       	push   $0x8021a1
  8013aa:	68 a8 21 80 00       	push   $0x8021a8
  8013af:	6a 7c                	push   $0x7c
  8013b1:	68 96 21 80 00       	push   $0x802196
  8013b6:	e8 bd 05 00 00       	call   801978 <_panic>
	assert(r <= PGSIZE);
  8013bb:	3d 00 10 00 00       	cmp    $0x1000,%eax
  8013c0:	7e 16                	jle    8013d8 <devfile_read+0x65>
  8013c2:	68 bd 21 80 00       	push   $0x8021bd
  8013c7:	68 a8 21 80 00       	push   $0x8021a8
  8013cc:	6a 7d                	push   $0x7d
  8013ce:	68 96 21 80 00       	push   $0x802196
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8014b1:	68 c9 21 80 00       	push   $0x8021c9
  8014b6:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801561:	50                   	push   %eax
  801562:	56                   	push   %esi
  801563:	68 d0 21 80 00       	push   $0x8021d0
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801805:	68 e8 21 80 00       	push   $0x8021e8
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801994:	56                   	push   %esi
  801995:	50                   	push   %eax
  801996:	68 f4 21 80 00       	push   $0x8021f4
  ...
  8019a7:	e8 44 e7 ff ff       	call   8000f0 <vcprintf>
	cprintf("\n");
  8019ac:	c7 04 24 e1 21 80 00 	movl   $0x8021e1,(%esp)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801a5f:	50                   	push   %eax
  801a60:	68 18 22 80 00       	push   $0x802218
  801a65:	6a 49                	push   $0x49
  801a67:	68 25 22 80 00       	push   $0x802225
