...
umain(int argc, char **argv)
{
  ...
  800036:	83 ec 08             	sub    $0x8,%esp
	binaryname = "idle";
  800039:	c7 05 00 30 80 00 a0 	movl   $0x801da0,0x803000
  800040:	1d 80 00 
...
sys_env_destroy(envid_t envid)
{
  ...
  80010f:	68 af 1d 80 00       	push   $0x801daf
  800114:	6a 23                	push   $0x23
  800116:	68 cc 1d 80 00       	push   $0x801dcc
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800190:	68 af 1d 80 00       	push   $0x801daf
  800195:	6a 23                	push   $0x23
  800197:	68 cc 1d 80 00       	push   $0x801dcc
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001d2:	68 af 1d 80 00       	push   $0x801daf
  8001d7:	6a 23                	push   $0x23
  8001d9:	68 cc 1d 80 00       	push   $0x801dcc
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800214:	68 af 1d 80 00       	push   $0x801daf
  800219:	6a 23                	push   $0x23
  80021b:	68 cc 1d 80 00       	push   $0x801dcc
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800256:	68 af 1d 80 00       	push   $0x801daf
  80025b:	6a 23                	push   $0x23
  80025d:	68 cc 1d 80 00       	push   $0x801dcc
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800298:	68 af 1d 80 00       	push   $0x801daf
  80029d:	6a 23                	push   $0x23
  80029f:	68 cc 1d 80 00       	push   $0x801dcc
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8002da:	68 af 1d 80 00       	push   $0x801daf
  8002df:	6a 23                	push   $0x23
  8002e1:	68 cc 1d 80 00       	push   $0x801dcc
...
sys_ipc_recv(void *dstva)
{
  ...
  80033e:	68 af 1d 80 00       	push   $0x801daf
  800343:	6a 23                	push   $0x23
  800345:	68 cc 1d 80 00       	push   $0x801dcc
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  80042c:	ba 58 1e 80 00       	mov    $0x801e58,%edx
	int i;
	for (i = 0; devtab[i]; i++)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800457:	51                   	push   %ecx
  800458:	50                   	push   %eax
  800459:	68 dc 1d 80 00       	push   $0x801ddc
...
read(int fdnum, void *buf, size_t n)
{
  ...
  800681:	53                   	push   %ebx
  800682:	50                   	push   %eax
  800683:	68 1d 1e 80 00       	push   $0x801e1d
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  800756:	53                   	push   %ebx
  800757:	50                   	push   %eax
  800758:	68 39 1e 80 00       	push   $0x801e39
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  80080b:	53                   	push   %ebx
  80080c:	50                   	push   %eax
  80080d:	68 fc 1d 80 00       	push   $0x801dfc
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  800a61:	68 68 1e 80 00       	push   $0x801e68
  800a66:	68 6f 1e 80 00       	push   $0x801e6f
  800a6b:	6a 7c                	push   $0x7c
  800a6d:	68 84 1e 80 00       	push   $0x801e84
  800a72:	e8 bd 05 00 00       	call   801034 <_panic>
	assert(r <= PGSIZE);
  800a77:	3d 00 10 00 00       	cmp    $0x1000,%eax
  800a7c:	7e 16                	jle    800a94 <devfile_read+0x65>
  800a7e:	68 8f 1e 80 00       	push   $0x801e8f
  800a83:	68 6f 1e 80 00       	push   $0x801e6f
  800a88:	6a 7d                	push   $0x7d
  800a8a:	68 84 1e 80 00       	push   $0x801e84
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800b6d:	68 9b 1e 80 00       	push   $0x801e9b
  800b72:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  800c1d:	50                   	push   %eax
  800c1e:	56                   	push   %esi
  800c1f:	68 a2 1e 80 00       	push   $0x801ea2
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800ec1:	68 ba 1e 80 00       	push   $0x801eba
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801050:	56                   	push   %esi
  801051:	50                   	push   %eax
  801052:	68 c8 1e 80 00       	push   $0x801ec8
  ...
  801063:	e8 54 00 00 00       	call   8010bc <vcprintf>
	cprintf("\n");
  801068:	c7 04 24 b3 1e 80 00 	movl   $0x801eb3,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8011bb:	0f be 80 eb 1e 80 00 	movsbl 0x801eeb(%eax),%eax
  8011c2:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  801386:	50                   	push   %eax
  801387:	68 03 1f 80 00       	push   $0x801f03
  80138c:	53                   	push   %ebx
  80138d:	56                   	push   %esi
  ...
  80139e:	52                   	push   %edx
  80139f:	68 81 1e 80 00       	push   $0x801e81
  8013a4:	53                   	push   %ebx
  8013a5:	56                   	push   %esi
  ...
  8013c3:	b8 fc 1e 80 00       	mov    $0x801efc,%eax
