...
umain(int argc, char **argv)
{
  ...
  800036:	83 ec 08             	sub    $0x8,%esp
	binaryname = "idle";
  800039:	c7 05 00 30 80 00 80 	movl   $0x801d80,0x803000
  800040:	1d 80 00 
...
sys_env_destroy(envid_t envid)
{
  ...
  80010f:	68 8f 1d 80 00       	push   $0x801d8f
  800114:	6a 23                	push   $0x23
  800116:	68 ac 1d 80 00       	push   $0x801dac
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800190:	68 8f 1d 80 00       	push   $0x801d8f
  800195:	6a 23                	push   $0x23
  800197:	68 ac 1d 80 00       	push   $0x801dac
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001d2:	68 8f 1d 80 00       	push   $0x801d8f
  8001d7:	6a 23                	push   $0x23
  8001d9:	68 ac 1d 80 00       	push   $0x801dac
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800214:	68 8f 1d 80 00       	push   $0x801d8f
  800219:	6a 23                	push   $0x23
  80021b:	68 ac 1d 80 00       	push   $0x801dac
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800256:	68 8f 1d 80 00       	push   $0x801d8f
  80025b:	6a 23                	push   $0x23
  80025d:	68 ac 1d 80 00       	push   $0x801dac
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800298:	68 8f 1d 80 00       	push   $0x801d8f
  80029d:	6a 23                	push   $0x23
  80029f:	68 ac 1d 80 00       	push   $0x801dac
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8002da:	68 8f 1d 80 00       	push   $0x801d8f
  8002df:	6a 23                	push   $0x23
  8002e1:	68 ac 1d 80 00       	push   $0x801dac
...
sys_ipc_recv(void *dstva)
{
  ...
  80033e:	68 8f 1d 80 00       	push   $0x801d8f
  800343:	6a 23                	push   $0x23
  800345:	68 ac 1d 80 00       	push   $0x801dac
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  80042c:	ba 38 1e 80 00       	mov    $0x801e38,%edx
	int i;
	for (i = 0; devtab[i]; i++)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800457:	51                   	push   %ecx
  800458:	50                   	push   %eax
  800459:	68 bc 1d 80 00       	push   $0x801dbc
...
read(int fdnum, void *buf, size_t n)
{
  ...
  800681:	53                   	push   %ebx
  800682:	50                   	push   %eax
  800683:	68 fd 1d 80 00       	push   $0x801dfd
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  800756:	53                   	push   %ebx
  800757:	50                   	push   %eax
  800758:	68 19 1e 80 00       	push   $0x801e19
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  80080b:	53                   	push   %ebx
  80080c:	50                   	push   %eax
  80080d:	68 dc 1d 80 00       	push   $0x801ddc
...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  8009f9:	83 ec 0c             	sub    $0xc,%esp
	...
	panic("devfile_write not implemented");
  8009fc:	68 48 1e 80 00       	push   $0x801e48
  800a01:	68 90 00 00 00       	push   $0x90
  800a06:	68 66 1e 80 00       	push   $0x801e66
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  800a42:	68 71 1e 80 00       	push   $0x801e71
  800a47:	68 78 1e 80 00       	push   $0x801e78
  800a4c:	6a 7c                	push   $0x7c
  800a4e:	68 66 1e 80 00       	push   $0x801e66
  800a53:	e8 bd 05 00 00       	call   801015 <_panic>
	assert(r <= PGSIZE);
  800a58:	3d 00 10 00 00       	cmp    $0x1000,%eax
  800a5d:	7e 16                	jle    800a75 <devfile_read+0x65>
  800a5f:	68 8d 1e 80 00       	push   $0x801e8d
  800a64:	68 78 1e 80 00       	push   $0x801e78
  800a69:	6a 7d                	push   $0x7d
  800a6b:	68 66 1e 80 00       	push   $0x801e66
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800b4e:	68 99 1e 80 00       	push   $0x801e99
  800b53:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  800bfe:	50                   	push   %eax
  800bff:	56                   	push   %esi
  800c00:	68 a0 1e 80 00       	push   $0x801ea0
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800ea2:	68 b8 1e 80 00       	push   $0x801eb8
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801031:	56                   	push   %esi
  801032:	50                   	push   %eax
  801033:	68 c4 1e 80 00       	push   $0x801ec4
  ...
  801044:	e8 54 00 00 00       	call   80109d <vcprintf>
	cprintf("\n");
  801049:	c7 04 24 b1 1e 80 00 	movl   $0x801eb1,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80119c:	0f be 80 e7 1e 80 00 	movsbl 0x801ee7(%eax),%eax
  8011a3:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  801367:	50                   	push   %eax
  801368:	68 ff 1e 80 00       	push   $0x801eff
  80136d:	53                   	push   %ebx
  80136e:	56                   	push   %esi
  ...
  80137f:	52                   	push   %edx
  801380:	68 8a 1e 80 00       	push   $0x801e8a
  801385:	53                   	push   %ebx
  801386:	56                   	push   %esi
  ...
  8013a4:	b8 f8 1e 80 00       	mov    $0x801ef8,%eax
