...
umain(int argc, char **argv)
{
  ...
  800067:	50                   	push   %eax
  800068:	68 24 23 80 00       	push   $0x802324
  80006d:	6a 09                	push   $0x9
  80006f:	68 3c 23 80 00       	push   $0x80233c
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8000f7:	56                   	push   %esi
  8000f8:	50                   	push   %eax
  8000f9:	68 58 23 80 00       	push   $0x802358
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800262:	0f be 80 7b 23 80 00 	movsbl 0x80237b(%eax),%eax
  800269:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80042d:	50                   	push   %eax
  80042e:	68 93 23 80 00       	push   $0x802393
  800433:	53                   	push   %ebx
  800434:	56                   	push   %esi
  ...
  80046a:	b8 8c 23 80 00       	mov    $0x80238c,%eax
