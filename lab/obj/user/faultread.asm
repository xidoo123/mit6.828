...
sys_e1000_try_send(void *data, uint32_t len)
{
  ...
  800d02:	68 9f 25 80 00       	push   $0x80259f
  800d07:	6a 23                	push   $0x23
  800d09:	68 bc 25 80 00       	push   $0x8025bc
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800df0:	ba 48 26 80 00       	mov    $0x802648,%edx
	int i;
	for (i = 0; devtab[i]; i++)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800e1b:	51                   	push   %ecx
  800e1c:	50                   	push   %eax
  800e1d:	68 cc 25 80 00       	push   $0x8025cc
...
read(int fdnum, void *buf, size_t n)
{
  ...
  801045:	53                   	push   %ebx
  801046:	50                   	push   %eax
  801047:	68 0d 26 80 00       	push   $0x80260d
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  80111a:	53                   	push   %ebx
  80111b:	50                   	push   %eax
  80111c:	68 29 26 80 00       	push   $0x802629
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8011cf:	53                   	push   %ebx
  8011d0:	50                   	push   %eax
  8011d1:	68 ec 25 80 00       	push   $0x8025ec
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  801425:	68 5c 26 80 00       	push   $0x80265c
  80142a:	68 63 26 80 00       	push   $0x802663
  80142f:	6a 7c                	push   $0x7c
  801431:	68 78 26 80 00       	push   $0x802678
  801436:	e8 24 0a 00 00       	call   801e5f <_panic>
	assert(r <= PGSIZE);
  80143b:	3d 00 10 00 00       	cmp    $0x1000,%eax
  801440:	7e 16                	jle    801458 <devfile_read+0x65>
  801442:	68 83 26 80 00       	push   $0x802683
  801447:	68 63 26 80 00       	push   $0x802663
  80144c:	6a 7d                	push   $0x7d
  80144e:	68 78 26 80 00       	push   $0x802678
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  80151f:	68 8f 26 80 00       	push   $0x80268f
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  8018c5:	68 9b 26 80 00       	push   $0x80269b
  8018ca:	68 63 26 80 00       	push   $0x802663
  8018cf:	6a 62                	push   $0x62
  8018d1:	68 b0 26 80 00       	push   $0x8026b0
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  801917:	68 63 26 80 00       	push   $0x802663
  80191c:	6a 6d                	push   $0x6d
  80191e:	68 b0 26 80 00       	push   $0x8026b0
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801998:	68 c8 26 80 00       	push   $0x8026c8
  80199d:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801a48:	50                   	push   %eax
  801a49:	56                   	push   %esi
  801a4a:	68 cf 26 80 00       	push   $0x8026cf
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801cec:	68 e7 26 80 00       	push   $0x8026e7
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801e7b:	56                   	push   %esi
  801e7c:	50                   	push   %eax
  801e7d:	68 f4 26 80 00       	push   $0x8026f4
  ...
  801e8e:	e8 5d e2 ff ff       	call   8000f0 <vcprintf>
	cprintf("\n");
  801e93:	c7 04 24 9c 22 80 00 	movl   $0x80229c,(%esp)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801f46:	50                   	push   %eax
  801f47:	68 18 27 80 00       	push   $0x802718
  801f4c:	6a 49                	push   $0x49
  801f4e:	68 25 27 80 00       	push   $0x802725
