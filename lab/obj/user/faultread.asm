	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001ef:	0f be 80 e8 22 80 00 	movsbl 0x8022e8(%eax),%eax
  8001f6:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8002eb:	ff 24 85 20 24 80 00 	jmp    *0x802420(,%eax,4)
  ...
  8003af:	8b 14 85 80 25 80 00 	mov    0x802580(,%eax,4),%edx
  8003b6:	85 d2                	test   %edx,%edx
  8003b8:	75 18                	jne    8003d2 <vprintfmt+0x15a>
				printfmt(putch, putdat, "error %d", err);
  8003ba:	50                   	push   %eax
  8003bb:	68 00 23 80 00       	push   $0x802300
  8003c0:	53                   	push   %ebx
  8003c1:	56                   	push   %esi
  ...
  8003d2:	52                   	push   %edx
  8003d3:	68 b5 26 80 00       	push   $0x8026b5
  8003d8:	53                   	push   %ebx
  8003d9:	56                   	push   %esi
  ...
  8003f7:	b8 f9 22 80 00       	mov    $0x8022f9,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800a72:	68 df 25 80 00       	push   $0x8025df
  800a77:	6a 23                	push   $0x23
  800a79:	68 fc 25 80 00       	push   $0x8025fc
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800af3:	68 df 25 80 00       	push   $0x8025df
  800af8:	6a 23                	push   $0x23
  800afa:	68 fc 25 80 00       	push   $0x8025fc
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800b35:	68 df 25 80 00       	push   $0x8025df
  800b3a:	6a 23                	push   $0x23
  800b3c:	68 fc 25 80 00       	push   $0x8025fc
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800b77:	68 df 25 80 00       	push   $0x8025df
  800b7c:	6a 23                	push   $0x23
  800b7e:	68 fc 25 80 00       	push   $0x8025fc
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800bb9:	68 df 25 80 00       	push   $0x8025df
  800bbe:	6a 23                	push   $0x23
  800bc0:	68 fc 25 80 00       	push   $0x8025fc
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800bfb:	68 df 25 80 00       	push   $0x8025df
  800c00:	6a 23                	push   $0x23
  800c02:	68 fc 25 80 00       	push   $0x8025fc
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800c3d:	68 df 25 80 00       	push   $0x8025df
  800c42:	6a 23                	push   $0x23
  800c44:	68 fc 25 80 00       	push   $0x8025fc
...
sys_ipc_recv(void *dstva)
{
  ...
  800ca1:	68 df 25 80 00       	push   $0x8025df
  800ca6:	6a 23                	push   $0x23
  800ca8:	68 fc 25 80 00       	push   $0x8025fc
...
sys_e1000_try_send(void *data, uint32_t len)
{
  ...
  800d02:	68 df 25 80 00       	push   $0x8025df
  800d07:	6a 23                	push   $0x23
  800d09:	68 fc 25 80 00       	push   $0x8025fc
...
sys_e1000_try_recv(void *buf, uint32_t* len)
{
  ...
  800d44:	68 df 25 80 00       	push   $0x8025df
  800d49:	6a 23                	push   $0x23
  800d4b:	68 fc 25 80 00       	push   $0x8025fc
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800e32:	ba 88 26 80 00       	mov    $0x802688,%edx
	int i;
	for (i = 0; devtab[i]; i++)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800e5d:	51                   	push   %ecx
  800e5e:	50                   	push   %eax
  800e5f:	68 0c 26 80 00       	push   $0x80260c
...
read(int fdnum, void *buf, size_t n)
{
  ...
  801087:	53                   	push   %ebx
  801088:	50                   	push   %eax
  801089:	68 4d 26 80 00       	push   $0x80264d
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  801211:	53                   	push   %ebx
  801212:	50                   	push   %eax
  801213:	68 2c 26 80 00       	push   $0x80262c
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  801467:	68 9c 26 80 00       	push   $0x80269c
  80146c:	68 a3 26 80 00       	push   $0x8026a3
  801471:	6a 7c                	push   $0x7c
  801473:	68 b8 26 80 00       	push   $0x8026b8
  801478:	e8 24 0a 00 00       	call   801ea1 <_panic>
	assert(r <= PGSIZE);
  80147d:	3d 00 10 00 00       	cmp    $0x1000,%eax
  801482:	7e 16                	jle    80149a <devfile_read+0x65>
  801484:	68 c3 26 80 00       	push   $0x8026c3
  801489:	68 a3 26 80 00       	push   $0x8026a3
  80148e:	6a 7d                	push   $0x7d
  801490:	68 b8 26 80 00       	push   $0x8026b8
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801561:	68 cf 26 80 00       	push   $0x8026cf
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  801907:	68 db 26 80 00       	push   $0x8026db
  80190c:	68 a3 26 80 00       	push   $0x8026a3
  801911:	6a 62                	push   $0x62
  801913:	68 f0 26 80 00       	push   $0x8026f0
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  801954:	68 fc 26 80 00       	push   $0x8026fc
  801959:	68 a3 26 80 00       	push   $0x8026a3
  80195e:	6a 6d                	push   $0x6d
  801960:	68 f0 26 80 00       	push   $0x8026f0
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8019da:	68 08 27 80 00       	push   $0x802708
  8019df:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801a8a:	50                   	push   %eax
  801a8b:	56                   	push   %esi
  801a8c:	68 0f 27 80 00       	push   $0x80270f
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801d2e:	68 27 27 80 00       	push   $0x802727
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801ebd:	56                   	push   %esi
  801ebe:	50                   	push   %eax
  801ebf:	68 34 27 80 00       	push   $0x802734
  ...
  801ed0:	e8 1b e2 ff ff       	call   8000f0 <vcprintf>
	cprintf("\n");
  801ed5:	c7 04 24 dc 22 80 00 	movl   $0x8022dc,(%esp)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801f88:	50                   	push   %eax
  801f89:	68 58 27 80 00       	push   $0x802758
  801f8e:	6a 49                	push   $0x49
  801f90:	68 65 27 80 00       	push   $0x802765
