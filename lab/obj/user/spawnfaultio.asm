...
umain(int argc, char **argv)
{
  ...
  800067:	50                   	push   %eax
  800068:	68 c6 28 80 00       	push   $0x8028c6
  80006d:	6a 09                	push   $0x9
  80006f:	68 e0 28 80 00       	push   $0x8028e0
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800262:	0f be 80 23 29 80 00 	movsbl 0x802923(%eax),%eax
  800269:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80042d:	50                   	push   %eax
  80042e:	68 3b 29 80 00       	push   $0x80293b
  800433:	53                   	push   %ebx
  800434:	56                   	push   %esi
  ...
  80046a:	b8 34 29 80 00       	mov    $0x802934,%eax
