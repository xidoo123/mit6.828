...
umain(int argc, char **argv)
{
  ...
  8000e0:	e8 55 1a 00 00       	call   801b3a <socket>
  ...
  800149:	53                   	push   %ebx
  80014a:	56                   	push   %esi
  80014b:	e8 58 19 00 00       	call   801aa8 <bind>
  ...
  800166:	56                   	push   %esi
  800167:	e8 ab 19 00 00       	call   801b17 <listen>
  ...
  80019e:	50                   	push   %eax
  80019f:	56                   	push   %esi
  8001a0:	e8 cc 18 00 00       	call   801a71 <accept>
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801951:	68 cf 2b 80 00       	push   $0x802bcf
  801956:	ff 75 0c             	pushl  0xc(%ebp)
  801959:	e8 dc f1 ff ff       	call   800b3a <strcpy>
	return 0;
}
...
devsock_close(struct Fd *fd)
{
  ...
  80196c:	8b 5d 08             	mov    0x8(%ebp),%ebx
	if (pageref(fd) == 1)
  80196f:	53                   	push   %ebx
  801970:	e8 56 0a 00 00       	call   8023cb <pageref>
...
alloc_sockfd(int sockid)
{
  ...
  801a28:	e8 10 f5 ff ff       	call   800f3d <sys_page_alloc>
...
nsipc(unsigned type)
{
  ...
  801b63:	89 c3                	mov    %eax,%ebx
	...
	if (nsenv == 0)
  801b65:	83 3d 14 40 80 00 00 	cmpl   $0x0,0x804014
  801b6c:	75 12                	jne    801b80 <nsipc+0x24>
		nsenv = ipc_find_env(ENV_TYPE_NS);
  801b6e:	83 ec 0c             	sub    $0xc,%esp
  801b71:	6a 02                	push   $0x2
  801b73:	e8 1a 08 00 00       	call   802392 <ipc_find_env>
  801b78:	a3 14 40 80 00       	mov    %eax,0x804014
  ...
  801b87:	53                   	push   %ebx
  801b88:	ff 35 14 40 80 00    	pushl  0x804014
  801b8e:	e8 ab 07 00 00       	call   80233e <ipc_send>
	return ipc_recv(NULL, NULL, NULL);
  801b93:	83 c4 0c             	add    $0xc,%esp
  801b96:	6a 00                	push   $0x0
  801b98:	6a 00                	push   $0x0
  801b9a:	6a 00                	push   $0x0
  801b9c:	e8 36 07 00 00       	call   8022d7 <ipc_recv>
}
...
nsipc_accept(int s, struct sockaddr *addr, socklen_t *addrlen)
{
  ...
  801bde:	e8 e9 f0 ff ff       	call   800ccc <memmove>
...
nsipc_bind(int s, struct sockaddr *name, socklen_t namelen)
{
  ...
  801c11:	e8 b6 f0 ff ff       	call   800ccc <memmove>
...
nsipc_connect(int s, const struct sockaddr *name, socklen_t namelen)
{
  ...
  801c82:	e8 45 f0 ff ff       	call   800ccc <memmove>
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  801cf7:	68 db 2b 80 00       	push   $0x802bdb
  801cfc:	68 a3 2b 80 00       	push   $0x802ba3
  801d01:	6a 62                	push   $0x62
  801d03:	68 f0 2b 80 00       	push   $0x802bf0
  801d08:	e8 84 05 00 00       	call   802291 <_panic>
		memmove(mem, nsipcbuf.recvRet.ret_buf, r);
  801d0d:	83 ec 04             	sub    $0x4,%esp
  801d10:	50                   	push   %eax
  801d11:	68 00 60 80 00       	push   $0x806000
  801d16:	ff 75 0c             	pushl  0xc(%ebp)
  801d19:	e8 ae ef ff ff       	call   800ccc <memmove>
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  801d44:	68 fc 2b 80 00       	push   $0x802bfc
  801d49:	68 a3 2b 80 00       	push   $0x802ba3
  801d4e:	6a 6d                	push   $0x6d
  801d50:	68 f0 2b 80 00       	push   $0x802bf0
  801d55:	e8 37 05 00 00       	call   802291 <_panic>
	memmove(&nsipcbuf.send.req_buf, buf, size);
  801d5a:	83 ec 04             	sub    $0x4,%esp
  801d5d:	53                   	push   %ebx
  801d5e:	ff 75 0c             	pushl  0xc(%ebp)
  801d61:	68 0c 60 80 00       	push   $0x80600c
  801d66:	e8 61 ef ff ff       	call   800ccc <memmove>
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801dca:	68 08 2c 80 00       	push   $0x802c08
  801dcf:	53                   	push   %ebx
  801dd0:	e8 65 ed ff ff       	call   800b3a <strcpy>
...
devpipe_close(struct Fd *fd)
{
  ...
  801e0d:	e8 b0 f1 ff ff       	call   800fc2 <sys_page_unmap>
  ...
  801e20:	e8 9d f1 ff ff       	call   800fc2 <sys_page_unmap>
}
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801e60:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
		nn = thisenv->env_runs;
  801e63:	8b 15 18 40 80 00    	mov    0x804018,%edx
  ...
  801e7a:	50                   	push   %eax
  801e7b:	56                   	push   %esi
  801e7c:	68 0f 2c 80 00       	push   $0x802c0f
  801e81:	e8 2f e7 ff ff       	call   8005b5 <cprintf>
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  801ebf:	75 48                	jne    801f09 <devpipe_write+0x73>
			...
			sys_yield();
  801ec1:	e8 58 f0 ff ff       	call   800f1e <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  801f47:	75 32                	jne    801f7b <devpipe_read+0x65>
			...
			sys_yield();
  801f49:	e8 d0 ef ff ff       	call   800f1e <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
pipe(int pfd[2])
{
  ...
  801fb3:	e8 85 ef ff ff       	call   800f3d <sys_page_alloc>
  ...
  801feb:	e8 4d ef ff ff       	call   800f3d <sys_page_alloc>
  ...
  802015:	e8 23 ef ff ff       	call   800f3d <sys_page_alloc>
  ...
  80203f:	e8 3c ef ff ff       	call   800f80 <sys_page_map>
  ...
  8020a8:	e8 15 ef ff ff       	call   800fc2 <sys_page_unmap>
  ...
  8020b8:	e8 05 ef ff ff       	call   800fc2 <sys_page_unmap>
  ...
  8020c8:	e8 f5 ee ff ff       	call   800fc2 <sys_page_unmap>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8022c0:	e8 9f e2 ff ff       	call   800564 <vcprintf>
	cprintf("\n");
  8022c5:	c7 04 24 20 2c 80 00 	movl   $0x802c20,(%esp)
