...
sys_env_destroy(envid_t envid)
{
  ...
  800aa8:	e8 60 02 00 00       	call   800d0d <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b29:	e8 df 01 00 00       	call   800d0d <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800b6b:	e8 9d 01 00 00       	call   800d0d <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800bad:	e8 5b 01 00 00       	call   800d0d <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800bef:	e8 19 01 00 00       	call   800d0d <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800c31:	e8 d7 00 00 00       	call   800d0d <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800c95:	e8 73 00 00 00       	call   800d0d <_panic>
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800caf:	75 2e                	jne    800cdf <set_pgfault_handler+0x3d>
		// First time through!
		// LAB 4: Your code here.
		// panic("set_pgfault_handler not implemented");

		sys_page_alloc(sys_getenvid(), (void *) (UXSTACKTOP - PGSIZE), PTE_SYSCALL);
  800cb1:	e8 ff fd ff ff       	call   800ab5 <sys_getenvid>
  800cb6:	83 ec 04             	sub    $0x4,%esp
  800cb9:	68 07 0e 00 00       	push   $0xe07
  800cbe:	68 00 f0 bf ee       	push   $0xeebff000
  800cc3:	50                   	push   %eax
  800cc4:	e8 2a fe ff ff       	call   800af3 <sys_page_alloc>
		sys_env_set_pgfault_upcall(sys_getenvid(), _pgfault_upcall);
  800cc9:	e8 e7 fd ff ff       	call   800ab5 <sys_getenvid>
  800cce:	83 c4 08             	add    $0x8,%esp
  800cd1:	68 e9 0c 80 00       	push   $0x800ce9
  800cd6:	50                   	push   %eax
  800cd7:	e8 20 ff ff ff       	call   800bfc <sys_env_set_pgfault_upcall>
  ...
  800ce2:	a3 08 20 80 00       	mov    %eax,0x802008
}
  800ce7:	c9                   	leave  
  800ce8:	c3                   	ret    

00800ce9 <_pgfault_upcall>:
...
_pgfault_upcall:
  ...
  800cea:	a1 08 20 80 00       	mov    0x802008,%eax
	call *%eax
  ...
  800cf4:	8b 44 24 30          	mov    0x30(%esp),%eax
	movl 40(%esp), %ebx		// trap-time eip
  800cf8:	8b 5c 24 28          	mov    0x28(%esp),%ebx

	// load eip into esp-4
	// in order to return to trap-time eip later, in the meantime not changing trap-time esp
	movl %ebx, -4(%eax)	
  800cfc:	89 58 fc             	mov    %ebx,-0x4(%eax)
  ...
  800d08:	8d 64 24 fc          	lea    -0x4(%esp),%esp
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800d11:	53                   	push   %ebx
	...
	va_start(ap, fmt);
  800d12:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  800d15:	8b 35 00 20 80 00    	mov    0x802000,%esi
  800d1b:	e8 95 fd ff ff       	call   800ab5 <sys_getenvid>
  800d20:	83 ec 0c             	sub    $0xc,%esp
  800d23:	ff 75 0c             	pushl  0xc(%ebp)
  800d26:	ff 75 08             	pushl  0x8(%ebp)
  800d29:	56                   	push   %esi
  800d2a:	50                   	push   %eax
  800d2b:	68 90 12 80 00       	push   $0x801290
  800d30:	e8 36 f4 ff ff       	call   80016b <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800d35:	83 c4 18             	add    $0x18,%esp
  800d38:	53                   	push   %ebx
  800d39:	ff 75 10             	pushl  0x10(%ebp)
  800d3c:	e8 d9 f3 ff ff       	call   80011a <vcprintf>
	cprintf("\n");
  800d41:	c7 04 24 1a 10 80 00 	movl   $0x80101a,(%esp)
  800d48:	e8 1e f4 ff ff       	call   80016b <cprintf>
  800d4d:	83 c4 10             	add    $0x10,%esp
	...
	while (1)
		asm volatile("int3");
  800d50:	cc                   	int3   
  800d51:	eb fd                	jmp    800d50 <_panic+0x43>
