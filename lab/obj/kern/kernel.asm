...
f010019c:	68 5c d2 1b f0       	push   $0xf01bd25c
...
f01049f9:	8b 80 28 20 21 f0    	mov    -0xfdedfd8(%eax),%eax
...
f0104bb0:	ff b0 28 20 21 f0    	pushl  -0xfdedfd8(%eax)
...
f0104c0c:	ff b0 28 20 21 f0    	pushl  -0xfdedfd8(%eax)
...
f0105410:	83 c4 10             	add    $0x10,%esp
			buf[i++] = c;
f0105413:	88 9e 80 1a 21 f0    	mov    %bl,-0xfdee580(%esi)
...
f010543d:	83 c4 10             	add    $0x10,%esp
			buf[i] = 0;
f0105440:	c6 86 80 1a 21 f0 00 	movb   $0x0,-0xfdee580(%esi)
			return buf;
f0105447:	b8 80 1a 21 f0       	mov    $0xf0211a80,%eax
		}
	}
}
...
f0105819:	8b 25 84 1e 21 f0    	mov    0xf0211e84,%esp
	movl    $0x0, %ebp       # nuke frame pointer
...
{
	if (PGNUM(pa) >= npages)
f0105858:	8b 0d 88 1e 21 f0    	mov    0xf0211e88,%ecx
...
f01058ee:	83 ec 1c             	sub    $0x1c,%esp
	...
	bootcpu = &cpus[0];
f01058f1:	c7 05 c0 23 21 f0 20 	movl   $0xf0212020,0xf02123c0
f01058f8:	20 21 f0 
#define KADDR(pa) _kaddr(__FILE__, __LINE__, pa)
...
{
	if (PGNUM(pa) >= npages)
f01058fb:	83 3d 88 1e 21 f0 00 	cmpl   $0x0,0xf0211e88
...
f010599f:	3b 05 88 1e 21 f0    	cmp    0xf0211e88,%eax
...
f0105a99:	0f 84 33 01 00 00    	je     f0105bd2 <mp_init+0x2ea>
		return;
	ismp = 1;
f0105a9f:	c7 05 00 20 21 f0 01 	movl   $0x1,0xf0212000
f0105aa6:	00 00 00 
	lapicaddr = conf->lapicaddr;
f0105aa9:	8b 43 24             	mov    0x24(%ebx),%eax
f0105aac:	a3 00 30 25 f0       	mov    %eax,0xf0253000
...
f0105acf:	74 11                	je     f0105ae2 <mp_init+0x1fa>
				bootcpu = &cpus[ncpu];
f0105ad1:	6b 05 c4 23 21 f0 74 	imul   $0x74,0xf02123c4,%eax
f0105ad8:	05 20 20 21 f0       	add    $0xf0212020,%eax
f0105add:	a3 c0 23 21 f0       	mov    %eax,0xf02123c0
			if (ncpu < NCPU) {
f0105ae2:	a1 c4 23 21 f0       	mov    0xf02123c4,%eax
f0105ae7:	83 f8 07             	cmp    $0x7,%eax
f0105aea:	7f 13                	jg     f0105aff <mp_init+0x217>
				cpus[ncpu].cpu_id = ncpu;
f0105aec:	6b d0 74             	imul   $0x74,%eax,%edx
f0105aef:	88 82 20 20 21 f0    	mov    %al,-0xfdedfe0(%edx)
				ncpu++;
f0105af5:	83 c0 01             	add    $0x1,%eax
f0105af8:	a3 c4 23 21 f0       	mov    %eax,0xf02123c4
...
f0105b2a:	e8 49 dd ff ff       	call   f0103878 <cprintf>
			ismp = 0;
f0105b2f:	c7 05 00 20 21 f0 00 	movl   $0x0,0xf0212000
f0105b36:	00 00 00 
			i = conf->entry;
...
f0105b4f:	a1 c0 23 21 f0       	mov    0xf02123c0,%eax
f0105b54:	c7 40 04 01 00 00 00 	movl   $0x1,0x4(%eax)
	if (!ismp) {
f0105b5b:	83 3d 00 20 21 f0 00 	cmpl   $0x0,0xf0212000
f0105b62:	75 26                	jne    f0105b8a <mp_init+0x2a2>
		// Didn't like what we found; fall back to no MP.
		ncpu = 1;
f0105b64:	c7 05 c4 23 21 f0 01 	movl   $0x1,0xf02123c4
f0105b6b:	00 00 00 
		lapicaddr = 0;
f0105b6e:	c7 05 00 30 25 f0 00 	movl   $0x0,0xf0253000
f0105b75:	00 00 00 
...
f0105b8d:	ff 35 c4 23 21 f0    	pushl  0xf02123c4
...
f0105bdb:	89 e5                	mov    %esp,%ebp
	lapic[index] = value;
f0105bdd:	8b 0d 04 30 25 f0    	mov    0xf0253004,%ecx
f0105be3:	8d 04 81             	lea    (%ecx,%eax,4),%eax
f0105be6:	89 10                	mov    %edx,(%eax)
	lapic[ID];  // wait for write to finish, by reading
f0105be8:	a1 04 30 25 f0       	mov    0xf0253004,%eax
...
f0105bf3:	89 e5                	mov    %esp,%ebp
	if (lapic)
f0105bf5:	a1 04 30 25 f0       	mov    0xf0253004,%eax
...
{
	if (!lapicaddr)
f0105c0d:	a1 00 30 25 f0       	mov    0xf0253000,%eax
...
f0105c2b:	a3 04 30 25 f0       	mov    %eax,0xf0253004
...
f0105c74:	05 20 20 21 f0       	add    $0xf0212020,%eax
f0105c79:	83 c4 10             	add    $0x10,%esp
f0105c7c:	39 05 c0 23 21 f0    	cmp    %eax,0xf02123c0
...
f0105ca2:	a1 04 30 25 f0       	mov    0xf0253004,%eax
...
f0105d1a:	8b 15 04 30 25 f0    	mov    0xf0253004,%edx
...
{
	if (lapic)
f0105d3d:	83 3d 04 30 25 f0 00 	cmpl   $0x0,0xf0253004
...
{
	if (PGNUM(pa) >= npages)
f0105d7c:	83 3d 88 1e 21 f0 00 	cmpl   $0x0,0xf0211e88
...
f0105e2d:	e8 a8 fd ff ff       	call   f0105bda <lapicw>
	while (lapic[ICRLO] & DELIVS)
f0105e32:	8b 15 04 30 25 f0    	mov    0xf0253004,%edx
...
f0105e78:	05 20 20 21 f0       	add    $0xf0212020,%eax
// other CPUs to waste time spinning to acquire it.
void
spin_lock(struct spinlock *lk)
{
...
f0105eb9:	05 20 20 21 f0       	add    $0xf0212020,%eax
...
f0105f19:	05 20 20 21 f0       	add    $0xf0212020,%eax
// Release the lock.
void
spin_unlock(struct spinlock *lk)
{
