...
Weird bugs when starting shell, always complain about `user_mem_check` error, the fault address indicates that the user exception stack is out of bound, so there might be an endless loop of exception happens, keep pushing info into exception stack. The very first crash happens at `0x80197c`, which is just a `pop $7` in `sh.asm`, I have no idea why this causes a page fault and goes into page fault handler in kernel(esp is valid afaik). 

```
x1do0@ubuntu:~/mit6.828/lab$ make run-icode
make[1]: Entering directory '/home/x1do0/mit6.828/lab'
+ cc kern/pmap.c
+ ld obj/kern/kernel
+ mk obj/kern/kernel.img
...
make[1]: Leaving directory '/home/x1do0/mit6.828/lab'
qemu-system-i386 -drive file=obj/kern/kernel.img,index=0,media=disk,format=raw -serial mon:stdio -gdb tcp::26000 -D qemu.log -smp 1 -drive file=obj/fs/fs.img,index=1,media=disk,format=raw  -nographic
6828 decimal is 15254 octal!
Physical memory: 131072K available, base = 640K, extended = 130432K
[?] non-boot CPUs (APs)
check_page_free_list() succeeded!
check_page_alloc() succeeded!
[boot_map_region] 0xef800000, len 0x2000
[boot_map_region] 0xef802000, len 0x1000
check_page() succeeded!
[boot_map_region] 0xef000000, len 0x400000
[boot_map_region] 0xeec00000, len 0x400000
[boot_map_region] 0xefff8000, len 0x8000
[boot_map_region] 0xf0000000, len 0x10000000
[boot_map_region] 0xefff8000, len 0x8000
[boot_map_region] 0xeffe8000, len 0x8000
[boot_map_region] 0xeffd8000, len 0x8000
[boot_map_region] 0xeffc8000, len 0x8000
[boot_map_region] 0xeffb8000, len 0x8000
[boot_map_region] 0xeffa8000, len 0x8000
[boot_map_region] 0xeff98000, len 0x8000
[boot_map_region] 0xeff88000, len 0x8000
check_kern_pgdir() succeeded!
check_page_free_list() succeeded!
check_page_installed_pgdir() succeeded!
SMP: CPU 0 found 1 CPU(s)
[boot_map_region] 0xef803000, len 0x1000
enabled interrupts: 1 2 4
FS is running
FS can do I/O
Device 1 presence: 1
Page fault at 0x10001000, env_pgfault_upcall: 0x8027d1
Page fault at 0x10001000, env_pgfault_upcall: 0x8027d1
Page fault at 0x10001000, env_pgfault_upcall: 0x8027d1
block cache is good
icode startup
icode: open /motd
superblock is good
Page fault at 0x10002000, env_pgfault_upcall: 0x8027d1
bitmap is good
alloc_block is good
Page fault at 0x1006a000, env_pgfault_upcall: 0x8027d1
Page fault at 0x1006b000, env_pgfault_upcall: 0x8027d1
file_open is good
Page fault at 0x10003000, env_pgfault_upcall: 0x8027d1
file_get_block is good
file_flush is good
file_truncate is good
file rewrite is good
icode: read /motd
Page fault at 0x10004000, env_pgfault_upcall: 0x8027d1
...
icode: close /motd
icode: spawn /init
Page fault at 0x10009000, env_pgfault_upcall: 0x8027d1
Page fault at 0x1000a000, env_pgfault_upcall: 0x8027d1
Page fault at 0x1000b000, env_pgfault_upcall: 0x8027d1
Page fault at 0x1000c000, env_pgfault_upcall: 0x8027d1
Page fault at 0x1000d000, env_pgfault_upcall: 0x8027d1
Page fault at 0x1000e000, env_pgfault_upcall: 0x8027d1
icode: exiting
init: running
...
init: running sh
init: starting sh
Page fault at 0x1003f000, env_pgfault_upcall: 0x8027d1
Page fault at 0x10040000, env_pgfault_upcall: 0x8027d1
Page fault at 0x10041000, env_pgfault_upcall: 0x8027d1
Page fault at 0x10042000, env_pgfault_upcall: 0x8027d1
Page fault at 0x10043000, env_pgfault_upcall: 0x8027d1
Page fault at 0x10044000, env_pgfault_upcall: 0x8027d1
$ a
Page fault at 0xeebfdf54, env_pgfault_upcall: 0x802e32
[hit file is not a valid executable]
[hit 0x80197c]
[hit 8193]
Page fault at 0x80184e, env_pgfault_upcall: 0x802e32
Page fault at 0x802e32, env_pgfault_upcall: 0x802e32
Page fault at 0x802e32, env_pgfault_upcall: 0x802e32
Page fault at 0x802e32, env_pgfault_upcall: 0x802e32
Page fault at 0x802e32, env_pgfault_upcall: 0x802e32
Page fault at 0x802e32, env_pgfault_upcall: 0x802e32
...
Error hit
Error hit3, 0x362027
Error hit4, 0xf0362000, 0x0
[-] page [0x0] error, 0, 7
[00001003] user_mem_check assertion failure for va eebfefd4
$
```
...
PTE_SHARE [testpteshare]: OK (1.3s)
PTE_SHARE [testfdsharing]: OK (1.8s)
start the shell [icode]: Timeout! OK (30.7s)
testshell: FAIL (0.6s)
    AssertionError: ...
         ===
         No runnable environments in the system!
         Welcome to the JOS kernel monitor!
         Type 'help' for a list of commands.
         qemu: terminating on signal 15 from pid 16675
    MISSING 'shell ran correctly'

    QEMU output saved to jos.out.testshell
primespipe: OK (32.2s)
Score: 135/150
GNUmakefile:211: recipe for target 'grade' failed
make: *** [grade] Error 1
```
